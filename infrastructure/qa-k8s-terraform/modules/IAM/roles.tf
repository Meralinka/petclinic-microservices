...
resource "aws_iam_role" "role_for_master" {
  ...
  tags = {
    Name = "role_for_master-1"
  }
}

resource "aws_iam_role" "role_for_worker" {
  name = "role_worker_k8s-1"
